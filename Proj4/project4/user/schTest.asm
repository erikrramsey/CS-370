...
user/_schTest:     file format elf64-littleriscv


Disassembly of section .text:

0000000000000000 <primeCount>:
...
int primeCount(unsigned long limit) {
   ...
   6:	4789                	li	a5,2
   8:	02a7fd63          	bgeu	a5,a0,42 <primeCount+0x42>
   c:	0005059b          	sext.w	a1,a0
  10:	4689                	li	a3,2
    int count = 0;
  12:	4501                	li	a0,0
        int is_prime = 1;
  ...
  14:	488d                	li	a7,3
  16:	4809                	li	a6,2
  18:	a031                	j	24 <primeCount+0x24>
           if (i % j == 0) is_prime = 0; 
        }
        if (is_prime) {
  1a:	c311                	beqz	a4,1e <primeCount+0x1e>
            count++;
  1c:	2505                	addiw	a0,a0,1
    for (int i = 2; i < limit; i++) {
  1e:	2685                	addiw	a3,a3,1
  20:	02b68263          	beq	a3,a1,44 <primeCount+0x44>
        for (int j = 2; j <= i / 2 && is_prime; j++) {
  24:	01f6d61b          	srliw	a2,a3,0x1f
  28:	9e35                	addw	a2,a2,a3
  2a:	4016561b          	sraiw	a2,a2,0x1
  2e:	87c2                	mv	a5,a6
  30:	fed8d6e3          	bge	a7,a3,1c <primeCount+0x1c>
           if (i % j == 0) is_prime = 0; 
  34:	02f6e73b          	remw	a4,a3,a5
        for (int j = 2; j <= i / 2 && is_prime; j++) {
  38:	2785                	addiw	a5,a5,1
  3a:	fef640e3          	blt	a2,a5,1a <primeCount+0x1a>
  3e:	fb7d                	bnez	a4,34 <primeCount+0x34>
  40:	bff9                	j	1e <primeCount+0x1e>
    int count = 0;
  42:	4501                	li	a0,0
        } 
    }
...
int main(int argc, char** argv) {
  ...
  5a:	86250513          	addi	a0,a0,-1950 # 8b8 <malloc+0xe6>
  5e:	00000097          	auipc	ra,0x0
  62:	6b6080e7          	jalr	1718(ra) # 714 <printf>
    printf("Starting children...\n");
  66:	00001517          	auipc	a0,0x1
  6a:	86a50513          	addi	a0,a0,-1942 # 8d0 <malloc+0xfe>
  6e:	00000097          	auipc	ra,0x0
  72:	6a6080e7          	jalr	1702(ra) # 714 <printf>
    for (int i = 0; i < MAX_PROCESS; i++) {
  76:	4481                	li	s1,0
  78:	4919                	li	s2,6
        pid = fork();
  7a:	00000097          	auipc	ra,0x0
  7e:	30a080e7          	jalr	778(ra) # 384 <fork>
        if (pid == 0) {
  82:	c90d                	beqz	a0,b4 <main+0x6a>
    for (int i = 0; i < MAX_PROCESS; i++) {
  84:	2485                	addiw	s1,s1,1
  86:	ff249ae3          	bne	s1,s2,7a <main+0x30>
  8a:	4499                	li	s1,6
        wait(0);
  8c:	4501                	li	a0,0
  8e:	00000097          	auipc	ra,0x0
  92:	306080e7          	jalr	774(ra) # 394 <wait>
    for (int i = 0; i < MAX_PROCESS; i++) {
  96:	34fd                	addiw	s1,s1,-1
  98:	f8f5                	bnez	s1,8c <main+0x42>
    printf("Sceduler tests done\n");
  9a:	00001517          	auipc	a0,0x1
  9e:	87650513          	addi	a0,a0,-1930 # 910 <malloc+0x13e>
  a2:	00000097          	auipc	ra,0x0
  a6:	672080e7          	jalr	1650(ra) # 714 <printf>
    exit(0);
  aa:	4501                	li	a0,0
  ac:	00000097          	auipc	ra,0x0
  b0:	2e0080e7          	jalr	736(ra) # 38c <exit>
            char priority[] = "fg";
  b4:	6799                	lui	a5,0x6
  b6:	7667879b          	addiw	a5,a5,1894
  ba:	fcf41c23          	sh	a5,-40(s0)
  be:	fc040d23          	sb	zero,-38(s0)
            if (i % 2 == 0) {
  c2:	0014f793          	andi	a5,s1,1
  c6:	cb8d                	beqz	a5,f8 <main+0xae>
            int count = primeCount(100000);
  c8:	6561                	lui	a0,0x18
  ca:	6a050513          	addi	a0,a0,1696 # 186a0 <__global_pointer$+0x1755f>
  ce:	00000097          	auipc	ra,0x0
  d2:	f32080e7          	jalr	-206(ra) # 0 <primeCount>
  d6:	862a                	mv	a2,a0
            printf("Prime count (%s): %d %d\n", priority, count, i);
  d8:	86a6                	mv	a3,s1
  da:	fd840593          	addi	a1,s0,-40
  de:	00001517          	auipc	a0,0x1
  e2:	81250513          	addi	a0,a0,-2030 # 8f0 <malloc+0x11e>
  e6:	00000097          	auipc	ra,0x0
  ea:	62e080e7          	jalr	1582(ra) # 714 <printf>
            exit(0);
  ee:	4501                	li	a0,0
  f0:	00000097          	auipc	ra,0x0
  f4:	29c080e7          	jalr	668(ra) # 38c <exit>
                setbkg();
  f8:	00000097          	auipc	ra,0x0
  fc:	33c080e7          	jalr	828(ra) # 434 <setbkg>
                strcpy(priority, "bg");
 100:	00000597          	auipc	a1,0x0
 104:	7e858593          	addi	a1,a1,2024 # 8e8 <malloc+0x116>
 108:	fd840513          	addi	a0,s0,-40
 10c:	00000097          	auipc	ra,0x0
 110:	00a080e7          	jalr	10(ra) # 116 <strcpy>
 114:	bf55                	j	c8 <main+0x7e>
...
strcpy(char *s, const char *t)
{
 ...
 126:	fee78fa3          	sb	a4,-1(a5) # 5fff <__global_pointer$+0x4ebe>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 484:	4b050513          	addi	a0,a0,1200 # 930 <digits>
 488:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 690:	29c90913          	addi	s2,s2,668 # 928 <malloc+0x156>
        while(*s != 0){
...
free(void *ap)
{
 ...
 758:	1fc7b783          	ld	a5,508(a5) # 950 <freep>
...
malloc(uint nbytes)
{
 ...
 7fa:	15a53503          	ld	a0,346(a0) # 950 <freep>
 ...
 82e:	12e78793          	addi	a5,a5,302 # 958 <base>
 832:	00000717          	auipc	a4,0x0
 836:	10f73f23          	sd	a5,286(a4) # 950 <freep>
 83a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 85c:	0ea73c23          	sd	a0,248(a4) # 950 <freep>
      return (void*)(p + 1);
