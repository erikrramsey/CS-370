...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	8e450513          	addi	a0,a0,-1820 # 62f8 <malloc+0x818>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	8a450513          	addi	a0,a0,-1884 # 6300 <malloc+0x820>
    ...
    exit(1);
     ...
     a7e:	8a650513          	addi	a0,a0,-1882 # 6320 <malloc+0x840>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	8b250513          	addi	a0,a0,-1870 # 6348 <malloc+0x868>
  ...
  if(unlink("big") < 0){
     ...
     ac6:	83650513          	addi	a0,a0,-1994 # 62f8 <malloc+0x818>
     ...
     af2:	87a50513          	addi	a0,a0,-1926 # 6368 <malloc+0x888>
     ...
     b10:	88450513          	addi	a0,a0,-1916 # 6390 <malloc+0x8b0>
     ...
     b2e:	87e50513          	addi	a0,a0,-1922 # 63a8 <malloc+0x8c8>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	88a50513          	addi	a0,a0,-1910 # 63d0 <malloc+0x8f0>
...
0000000000000b60 <unlinkread>:
{
  ...
  write(fd, "hello", SZ);
     ...
     b90:	87c58593          	addi	a1,a1,-1924 # 6408 <malloc+0x928>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	86858593          	addi	a1,a1,-1944 # 6450 <malloc+0x970>
  ...
  unlink("unlinkread");
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	77850513          	addi	a0,a0,1912 # 63e8 <malloc+0x908>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	78450513          	addi	a0,a0,1924 # 6410 <malloc+0x930>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	78850513          	addi	a0,a0,1928 # 6430 <malloc+0x950>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	79450513          	addi	a0,a0,1940 # 6458 <malloc+0x978>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	79850513          	addi	a0,a0,1944 # 6478 <malloc+0x998>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	79c50513          	addi	a0,a0,1948 # 6498 <malloc+0x9b8>
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	6a858593          	addi	a1,a1,1704 # 6408 <malloc+0x928>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	74058593          	addi	a1,a1,1856 # 64c0 <malloc+0x9e0>
     d88:	00005517          	auipc	a0,0x5
     d8c:	73050513          	addi	a0,a0,1840 # 64b8 <malloc+0x9d8>
  ...
  unlink("lf1");
     ...
     da0:	71c50513          	addi	a0,a0,1820 # 64b8 <malloc+0x9d8>
     da4:	00005097          	auipc	ra,0x5
     da8:	956080e7          	jalr	-1706(ra) # 56fa <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00005517          	auipc	a0,0x5
     db2:	70a50513          	addi	a0,a0,1802 # 64b8 <malloc+0x9d8>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	6fc50513          	addi	a0,a0,1788 # 64c0 <malloc+0x9e0>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	6c458593          	addi	a1,a1,1732 # 64c0 <malloc+0x9e0>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	6ae50513          	addi	a0,a0,1710 # 64c0 <malloc+0x9e0>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	8e0080e7          	jalr	-1824(ra) # 56fa <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00005597          	auipc	a1,0x5
     e26:	69658593          	addi	a1,a1,1686 # 64b8 <malloc+0x9d8>
     e2a:	00005517          	auipc	a0,0x5
     e2e:	69650513          	addi	a0,a0,1686 # 64c0 <malloc+0x9e0>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	67a58593          	addi	a1,a1,1658 # 64b8 <malloc+0x9d8>
     e46:	00005517          	auipc	a0,0x5
     e4a:	78250513          	addi	a0,a0,1922 # 65c8 <malloc+0xae8>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	66050513          	addi	a0,a0,1632 # 64c8 <malloc+0x9e8>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	65c50513          	addi	a0,a0,1628 # 64e0 <malloc+0xa00>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	65850513          	addi	a0,a0,1624 # 64f8 <malloc+0xa18>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	65c50513          	addi	a0,a0,1628 # 6518 <malloc+0xa38>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	67050513          	addi	a0,a0,1648 # 6548 <malloc+0xa68>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	66c50513          	addi	a0,a0,1644 # 6560 <malloc+0xa80>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	66850513          	addi	a0,a0,1640 # 6578 <malloc+0xa98>
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f30:	67450513          	addi	a0,a0,1652 # 65a0 <malloc+0xac0>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	68850513          	addi	a0,a0,1672 # 65d0 <malloc+0xaf0>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	642a0a13          	addi	s4,s4,1602 # 65f0 <malloc+0xb10>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	5f050513          	addi	a0,a0,1520 # 65f0 <malloc+0xb10>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	58850513          	addi	a0,a0,1416 # 65f8 <malloc+0xb18>
    ...
    1094:	58850513          	addi	a0,a0,1416 # 6618 <malloc+0xb38>
    ...
    10b0:	58c50513          	addi	a0,a0,1420 # 6638 <malloc+0xb58>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	57a98993          	addi	s3,s3,1402 # 6658 <malloc+0xb78>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	54e50513          	addi	a0,a0,1358 # 6668 <malloc+0xb88>
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	62878793          	addi	a5,a5,1576 # 7838 <malloc+0x1d58>
  ...
  if(pid == 0){
    ...
    124a:	21a78793          	addi	a5,a5,538 # 8460 <big.1264>
    ...
    1270:	cdc78793          	addi	a5,a5,-804 # 7f48 <malloc+0x2468>
    ...
    12ac:	46850513          	addi	a0,a0,1128 # 6710 <malloc+0xc30>
    ...
    12cc:	3c050513          	addi	a0,a0,960 # 6688 <malloc+0xba8>
    ...
    12ec:	3c050513          	addi	a0,a0,960 # 66a8 <malloc+0xbc8>
    ...
    130e:	3be50513          	addi	a0,a0,958 # 66c8 <malloc+0xbe8>
    ...
    132e:	3c650513          	addi	a0,a0,966 # 66f0 <malloc+0xc10>
    ...
    1348:	82c50513          	addi	a0,a0,-2004 # 6b70 <malloc+0x1090>
  ...
  if(st != 747){
    ...
    1392:	3aa50513          	addi	a0,a0,938 # 6738 <malloc+0xc58>
...
00000000000013a8 <truncate3>:
{
  ...
  if(pid == 0){
    ...
    13f6:	3a6a8a93          	addi	s5,s5,934 # 6798 <malloc+0xcb8>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	30650513          	addi	a0,a0,774 # 6768 <malloc+0xc88>
    ...
    1482:	30250513          	addi	a0,a0,770 # 6780 <malloc+0xca0>
    ...
    14a0:	30c50513          	addi	a0,a0,780 # 67a8 <malloc+0xcc8>
    ...
    14c6:	306a8a93          	addi	s5,s5,774 # 67c8 <malloc+0xce8>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  exit(xstatus);
    ...
    152e:	25650513          	addi	a0,a0,598 # 6780 <malloc+0xca0>
    ...
    154c:	28850513          	addi	a0,a0,648 # 67d0 <malloc+0xcf0>
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1580:	27478793          	addi	a5,a5,628 # 67f0 <malloc+0xd10>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	26c50513          	addi	a0,a0,620 # 67f8 <malloc+0xd18>
  ...
  if(pid == 0) {
    ...
    15be:	23e50513          	addi	a0,a0,574 # 67f8 <malloc+0xd18>
    ...
    15da:	24250513          	addi	a0,a0,578 # 6818 <malloc+0xd38>
    ...
    15f6:	17650513          	addi	a0,a0,374 # 6768 <malloc+0xc88>
    ...
    1612:	1f250513          	addi	a0,a0,498 # 6800 <malloc+0xd20>
  ...
  if(xstatus != 0)
    ...
    1664:	1c850513          	addi	a0,a0,456 # 6828 <malloc+0xd48>
    ...
    1680:	1c450513          	addi	a0,a0,452 # 6840 <malloc+0xd60>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1694:	16850513          	addi	a0,a0,360 # 67f8 <malloc+0xd18>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	c0650513          	addi	a0,a0,-1018 # 62c0 <malloc+0x7e0>
    ...
    16da:	0aa50513          	addi	a0,a0,170 # 6780 <malloc+0xca0>
  ...
  unlink("echo-ok");
    ...
    16f4:	10850513          	addi	a0,a0,264 # 67f8 <malloc+0xd18>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	13e50513          	addi	a0,a0,318 # 6858 <malloc+0xd78>
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e0:	09450513          	addi	a0,a0,148 # 6870 <malloc+0xd90>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	02650513          	addi	a0,a0,38 # 6888 <malloc+0xda8>
    ...
    1882:	02250513          	addi	a0,a0,34 # 68a0 <malloc+0xdc0>
    ...
    18b4:	00850513          	addi	a0,a0,8 # 68b8 <malloc+0xdd8>
    ...
    18f4:	fe850513          	addi	a0,a0,-24 # 68d8 <malloc+0xdf8>
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	e0650513          	addi	a0,a0,-506 # 6768 <malloc+0xc88>
    ...
    1982:	f7250513          	addi	a0,a0,-142 # 68f0 <malloc+0xe10>
    ...
    199e:	f6e50513          	addi	a0,a0,-146 # 6908 <malloc+0xe28>
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	d5650513          	addi	a0,a0,-682 # 6768 <malloc+0xc88>
    ...
    1a3a:	d3250513          	addi	a0,a0,-718 # 6768 <malloc+0xc88>
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	e7850513          	addi	a0,a0,-392 # 6928 <malloc+0xe48>
    ...
    1ac6:	be8080e7          	jalr	-1048(ra) # 56aa <exit>
{
    ...
    1b0c:	e3050513          	addi	a0,a0,-464 # 6938 <malloc+0xe58>
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	01a50513          	addi	a0,a0,26 # 6b70 <malloc+0x1090>
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	f7c50513          	addi	a0,a0,-132 # 6b70 <malloc+0x1090>
    ...
    1c24:	be050513          	addi	a0,a0,-1056 # 6800 <malloc+0xd20>
    ...
    1c96:	cc650513          	addi	a0,a0,-826 # 6958 <malloc+0xe78>
    ...
    1cca:	caa50513          	addi	a0,a0,-854 # 6970 <malloc+0xe90>
    ...
    1d30:	c6c50513          	addi	a0,a0,-916 # 6998 <malloc+0xeb8>
...
0000000000001db0 <linkunlink>:
{
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e14:	bb0b8b93          	addi	s7,s7,-1104 # 69c0 <malloc+0xee0>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	94c50513          	addi	a0,a0,-1716 # 6768 <malloc+0xc88>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	c6650513          	addi	a0,a0,-922 # 6b70 <malloc+0x1090>
    ...
    1f4a:	c32b8b93          	addi	s7,s7,-974 # bb78 <buf>
    ...
    1fbe:	a0e50513          	addi	a0,a0,-1522 # 69c8 <malloc+0xee8>
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	9d050513          	addi	a0,a0,-1584 # 69f8 <malloc+0xf18>
  ...
  if(wait(0) != -1){
    ...
    208e:	95650513          	addi	a0,a0,-1706 # 69e0 <malloc+0xf00>
    ...
    20aa:	97a50513          	addi	a0,a0,-1670 # 6a20 <malloc+0xf40>
    ...
    20c6:	97650513          	addi	a0,a0,-1674 # 6a38 <malloc+0xf58>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	62650513          	addi	a0,a0,1574 # 6768 <malloc+0xc88>
    ...
    2168:	8ec50513          	addi	a0,a0,-1812 # 6a50 <malloc+0xf70>
...
0000000000002188 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2198:	8dc50513          	addi	a0,a0,-1828 # 6a70 <malloc+0xf90>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21ca:	8aa50513          	addi	a0,a0,-1878 # 6a70 <malloc+0xf90>
  ...
  close(fd);
    ...
    21f0:	17478793          	addi	a5,a5,372 # 8360 <args.1844>
    21f4:	00006697          	auipc	a3,0x6
    21f8:	26468693          	addi	a3,a3,612 # 8458 <args.1844+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    21fc:	00005717          	auipc	a4,0x5
    2200:	88470713          	addi	a4,a4,-1916 # 6a80 <malloc+0xfa0>
    ...
    2210:	15458593          	addi	a1,a1,340 # 8360 <args.1844>
    ...
    2230:	84450513          	addi	a0,a0,-1980 # 6a70 <malloc+0xf90>
    ...
    2254:	91050513          	addi	a0,a0,-1776 # 6b60 <malloc+0x1080>
    ...
    2278:	90c50513          	addi	a0,a0,-1780 # 6b80 <malloc+0x10a0>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22d6:	8ce50513          	addi	a0,a0,-1842 # 6ba0 <malloc+0x10c0>
    ...
    22f2:	47a50513          	addi	a0,a0,1146 # 6768 <malloc+0xc88>
...
0000000000002312 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    238c:	4b078793          	addi	a5,a5,1200 # 7838 <malloc+0x1d58>
  ...
  if(ret != -1){
    ...
    23ce:	7fe50513          	addi	a0,a0,2046 # 6bc8 <malloc+0x10e8>
    ...
    23ec:	2a050513          	addi	a0,a0,672 # 6688 <malloc+0xba8>
    ...
    240a:	2a250513          	addi	a0,a0,674 # 66a8 <malloc+0xbc8>
    ...
    242a:	2a250513          	addi	a0,a0,674 # 66c8 <malloc+0xbe8>
    ...
    2448:	2ac50513          	addi	a0,a0,684 # 66f0 <malloc+0xc10>
...
000000000000245e <rwsbrk>:
{
  ...
  if(n >= 0){
    ...
    24c6:	75e50513          	addi	a0,a0,1886 # 6c20 <malloc+0x1140>
    ...
    24e0:	6f450513          	addi	a0,a0,1780 # 6bd0 <malloc+0x10f0>
    ...
    24fa:	6f250513          	addi	a0,a0,1778 # 6be8 <malloc+0x1108>
    ...
    2514:	6f850513          	addi	a0,a0,1784 # 6c08 <malloc+0x1128>
  ...
  if(n >= 0){
    ...
    2574:	6e050513          	addi	a0,a0,1760 # 6c50 <malloc+0x1170>
    ...
    258e:	67e50513          	addi	a0,a0,1662 # 6c08 <malloc+0x1128>
...
00000000000025b8 <sbrkbasic>:
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2664:	63850513          	addi	a0,a0,1592 # 6c98 <malloc+0x11b8>
...
00000000000041ca <sbrkfail>:
{
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    42fa:	74a50513          	addi	a0,a0,1866 # 7a40 <malloc+0x1f60>
    ...
    4316:	45650513          	addi	a0,a0,1110 # 6768 <malloc+0xc88>
    ...
    4362:	70250513          	addi	a0,a0,1794 # 7a60 <malloc+0x1f80>
...
0000000000004382 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    43ea:	6aa50513          	addi	a0,a0,1706 # 7a90 <malloc+0x1fb0>
...
0000000000004428 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    44be:	5f650513          	addi	a0,a0,1526 # 7ab0 <malloc+0x1fd0>
    ...
    44da:	60250513          	addi	a0,a0,1538 # 7ad8 <malloc+0x1ff8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    455e:	59e50513          	addi	a0,a0,1438 # 7af8 <malloc+0x2018>
    ...
    4578:	fd2783e3          	beq	a5,s2,453e <sharedfd+0x116>
      if(buf[i] == 'c')
    457c:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1478>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    45c0:	56450513          	addi	a0,a0,1380 # 7b20 <malloc+0x2040>
...
00000000000045e0 <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4682:	4faa0a13          	addi	s4,s4,1274 # bb78 <buf>
    4686:	00007a97          	auipc	s5,0x7
    468a:	4f3a8a93          	addi	s5,s5,1267 # bb79 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    46a0:	4d450513          	addi	a0,a0,1236 # 6b70 <malloc+0x1090>
    ...
    4758:	40c50513          	addi	a0,a0,1036 # 7b60 <malloc+0x2080>
    ...
    4788:	3f478793          	addi	a5,a5,1012 # bb78 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    47e8:	38c50513          	addi	a0,a0,908 # 7b70 <malloc+0x2090>
...
000000000000481c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    484a:	342b8b93          	addi	s7,s7,834 # 7b88 <malloc+0x20a8>
  for(i = 0; i < N; i++){
    ...
    488c:	30850513          	addi	a0,a0,776 # 7b90 <malloc+0x20b0>
    ...
    48aa:	2e250513          	addi	a0,a0,738 # 7b88 <malloc+0x20a8>
  ...
  fd = open(".", 0);
    ...
    48e2:	cea50513          	addi	a0,a0,-790 # 65c8 <malloc+0xae8>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4908:	2ac50513          	addi	a0,a0,684 # 7bb0 <malloc+0x20d0>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4978:	25c50513          	addi	a0,a0,604 # 7bd0 <malloc+0x20f0>
  ...
  for(i = 0; i < N; i++){
    ...
    49b0:	24c50513          	addi	a0,a0,588 # 7bf8 <malloc+0x2118>
    ...
    49cc:	da050513          	addi	a0,a0,-608 # 6768 <malloc+0xc88>
...
0000000000004b76 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    4bfe:	03650513          	addi	a0,a0,54 # 7c30 <malloc+0x2150>
  ...
  for(i = 0; ; i++){
    ...
    4c62:	fe250513          	addi	a0,a0,-30 # 7c40 <malloc+0x2160>
    ...
    4c7e:	fe650513          	addi	a0,a0,-26 # 7c60 <malloc+0x2180>
    ...
    4c9a:	fea50513          	addi	a0,a0,-22 # 7c80 <malloc+0x21a0>
    ...
    4cb6:	fee50513          	addi	a0,a0,-18 # 7ca0 <malloc+0x21c0>
    ...
    4cd2:	ff250513          	addi	a0,a0,-14 # 7cc0 <malloc+0x21e0>
    ...
    4cee:	fee50513          	addi	a0,a0,-18 # 7cd8 <malloc+0x21f8>
  ...
  unlink("bigfile.dat");
    ...
    4d1c:	f1850513          	addi	a0,a0,-232 # 7c30 <malloc+0x2150>
    ...
    4d40:	fbc50513          	addi	a0,a0,-68 # 7cf8 <malloc+0x2218>
...
0000000000004d56 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4d78:	fa450513          	addi	a0,a0,-92 # 7d18 <malloc+0x2238>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4d98:	f94c8c93          	addi	s9,s9,-108 # 7d28 <malloc+0x2248>
    int total = 0;
    4d9c:	4d81                	li	s11,0
    ...
    4e12:	f2a50513          	addi	a0,a0,-214 # 7d38 <malloc+0x2258>
  ...
  printf("fsfull test finished\n");
    ...
    4e88:	ed450513          	addi	a0,a0,-300 # 7d58 <malloc+0x2278>
    ...
    4ed8:	e7450513          	addi	a0,a0,-396 # 7d48 <malloc+0x2268>
...
0000000000004f26 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4f9a:	dda50513          	addi	a0,a0,-550 # 7d70 <malloc+0x2290>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4fc8:	dcc50513          	addi	a0,a0,-564 # 7d90 <malloc+0x22b0>
    ...
    4fe2:	d9a50513          	addi	a0,a0,-614 # 7d78 <malloc+0x2298>
    ...
    4ffc:	d8050513          	addi	a0,a0,-640 # 7d78 <malloc+0x2298>
  ...
  unlink("junk");
    ...
    5020:	d5450513          	addi	a0,a0,-684 # 7d70 <malloc+0x2290>
