...
user/_psmb:     file format elf64-littleriscv
...
void print_proc(struct ps_proc* pr) {
  ...
  1c:	9bc68693          	addi	a3,a3,-1604 # 9d4 <malloc+0x1ee>
  20:	9736                	add	a4,a4,a3
  22:	4318                	lw	a4,0(a4)
  24:	9736                	add	a4,a4,a3
  26:	8702                	jr	a4
  28:	00001617          	auipc	a2,0x1
  2c:	8f060613          	addi	a2,a2,-1808 # 918 <malloc+0x132>
        default:
            state = "ERROR";
            break;
    }
  ...
  3a:	8f250513          	addi	a0,a0,-1806 # 928 <malloc+0x142>
  3e:	00000097          	auipc	ra,0x0
  42:	6ea080e7          	jalr	1770(ra) # 728 <printf>
}
  46:	60a2                	ld	ra,8(sp)
  48:	6402                	ld	s0,0(sp)
  ...
  52:	89a60613          	addi	a2,a2,-1894 # 8e8 <malloc+0x102>
            break;
  56:	bfe9                	j	30 <print_proc+0x30>
            state = "RUNNING   ";
  58:	00001617          	auipc	a2,0x1
  5c:	8a060613          	addi	a2,a2,-1888 # 8f8 <malloc+0x112>
            break;
  60:	bfc1                	j	30 <print_proc+0x30>
            state = "ZOMBIE    ";
  62:	00001617          	auipc	a2,0x1
  66:	8a660613          	addi	a2,a2,-1882 # 908 <malloc+0x122>
            break;
  6a:	b7d9                	j	30 <print_proc+0x30>
            state = "ERROR";
  6c:	00001617          	auipc	a2,0x1
  70:	86460613          	addi	a2,a2,-1948 # 8d0 <malloc+0xea>
            break;
  74:	bf75                	j	30 <print_proc+0x30>
            state = "USED      ";
  76:	00001617          	auipc	a2,0x1
  7a:	86260613          	addi	a2,a2,-1950 # 8d8 <malloc+0xf2>
...
int main(int argc, char** argv) {
  ...
  96:	754080e7          	jalr	1876(ra) # 7e6 <malloc>
  9a:	89aa                	mv	s3,a0
    setbkg();
  9c:	00000097          	auipc	ra,0x0
  a0:	3ac080e7          	jalr	940(ra) # 448 <setbkg>
    int total = ps(procs);
  a4:	854e                	mv	a0,s3
  a6:	00000097          	auipc	ra,0x0
  aa:	39a080e7          	jalr	922(ra) # 440 <ps>
  ae:	892a                	mv	s2,a0
    printf("Process Status\n");
  b0:	00001517          	auipc	a0,0x1
  b4:	89850513          	addi	a0,a0,-1896 # 948 <malloc+0x162>
  b8:	00000097          	auipc	ra,0x0
  bc:	670080e7          	jalr	1648(ra) # 728 <printf>
    printf("%s\n%s\n", header, div);
  c0:	00001617          	auipc	a2,0x1
  c4:	89860613          	addi	a2,a2,-1896 # 958 <malloc+0x172>
  c8:	00001597          	auipc	a1,0x1
  cc:	8c858593          	addi	a1,a1,-1848 # 990 <malloc+0x1aa>
  d0:	00001517          	auipc	a0,0x1
  d4:	8f850513          	addi	a0,a0,-1800 # 9c8 <malloc+0x1e2>
  d8:	00000097          	auipc	ra,0x0
  dc:	650080e7          	jalr	1616(ra) # 728 <printf>
    for (int i = 0; i < total; i++) {
  e0:	05205063          	blez	s2,120 <main+0xa0>
  e4:	84ce                	mv	s1,s3
  e6:	397d                	addiw	s2,s2,-1
  e8:	02091793          	slli	a5,s2,0x20
  ec:	9381                	srli	a5,a5,0x20
  ee:	00279913          	slli	s2,a5,0x2
  f2:	993e                	add	s2,s2,a5
  f4:	090e                	slli	s2,s2,0x3
  f6:	02898993          	addi	s3,s3,40
  fa:	994e                	add	s2,s2,s3
        printf("\n");
  fc:	00001997          	auipc	s3,0x1
 100:	8d498993          	addi	s3,s3,-1836 # 9d0 <malloc+0x1ea>
        print_proc(&procs[i]);
 104:	8526                	mv	a0,s1
 106:	00000097          	auipc	ra,0x0
 10a:	efa080e7          	jalr	-262(ra) # 0 <print_proc>
        printf("\n");
 10e:	854e                	mv	a0,s3
 110:	00000097          	auipc	ra,0x0
 114:	618080e7          	jalr	1560(ra) # 728 <printf>
    for (int i = 0; i < total; i++) {
 118:	02848493          	addi	s1,s1,40
 11c:	ff2494e3          	bne	s1,s2,104 <main+0x84>
    exit(0);
 120:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 498:	56450513          	addi	a0,a0,1380 # 9f8 <digits>
 49c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 564:	498b8b93          	addi	s7,s7,1176 # 9f8 <digits>
 ...
 6a4:	35090913          	addi	s2,s2,848 # 9f0 <malloc+0x20a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 76c:	2a87b783          	ld	a5,680(a5) # a10 <freep>
 ...
 79a:	00e6ea63          	bltu	a3,a4,7ae <free+0x50>
{
 ...
 7dc:	22f73c23          	sd	a5,568(a4) # a10 <freep>
}
 7e0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 80e:	20653503          	ld	a0,518(a0) # a10 <freep>
 ...
 836:	1de90913          	addi	s2,s2,478 # a10 <freep>
  if(p == (char*)-1)
 83a:	5afd                	li	s5,-1
 83c:	a88d                	j	8ae <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 83e:	00000797          	auipc	a5,0x0
 842:	1da78793          	addi	a5,a5,474 # a18 <base>
 846:	00000717          	auipc	a4,0x0
 84a:	1cf73523          	sd	a5,458(a4) # a10 <freep>
 84e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 870:	1aa73223          	sd	a0,420(a4) # a10 <freep>
      return (void*)(p + 1);
 ...
 8be:	b6e080e7          	jalr	-1170(ra) # 428 <sbrk>
  if(p == (char*)-1)
