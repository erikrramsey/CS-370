...
user/_ppt:     file format elf64-littleriscv
...
int main(int argc, char** argv) {
   ...
   c:	7c050513          	addi	a0,a0,1984 # 7c8 <malloc+0xea>
  10:	00000097          	auipc	ra,0x0
  14:	610080e7          	jalr	1552(ra) # 620 <printf>
    prtpgtbl();
  18:	00000097          	auipc	ra,0x0
  1c:	328080e7          	jalr	808(ra) # 340 <prtpgtbl>
    exit(0);
  20:	4501                	li	a0,0
  22:	00000097          	auipc	ra,0x0
  26:	27e080e7          	jalr	638(ra) # 2a0 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 390:	46450513          	addi	a0,a0,1124 # 7f0 <digits>
 394:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 45c:	398b8b93          	addi	s7,s7,920 # 7f0 <digits>
 ...
 59c:	25090913          	addi	s2,s2,592 # 7e8 <malloc+0x10a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 664:	1a87b783          	ld	a5,424(a5) # 808 <freep>
 ...
 692:	00e6ea63          	bltu	a3,a4,6a6 <free+0x50>
{
 ...
 6d4:	12f73c23          	sd	a5,312(a4) # 808 <freep>
}
 6d8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 706:	10653503          	ld	a0,262(a0) # 808 <freep>
 ...
 72e:	0de90913          	addi	s2,s2,222 # 808 <freep>
  if(p == (char*)-1)
 732:	5afd                	li	s5,-1
 734:	a88d                	j	7a6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 736:	00000797          	auipc	a5,0x0
 73a:	0da78793          	addi	a5,a5,218 # 810 <base>
 73e:	00000717          	auipc	a4,0x0
 742:	0cf73523          	sd	a5,202(a4) # 808 <freep>
 746:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 768:	0aa73223          	sd	a0,164(a4) # 808 <freep>
      return (void*)(p + 1);
